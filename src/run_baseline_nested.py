...
from ModelTraining.Baseline import train_baseline_nested
...
if __name__ == '__main__':
    ...
    data = [X_drug_feat_data,X_drug_adj_data,X_gexpr_data,Y]
    
    folds_auc_test = []
    n_outer_splits = 10
    best_params_file = "tuned_hyperparameters/Base_GDSC_nested_outer_CV_params.csv"
    print("Training......")
    auc_test_df = train_baseline_nested(n_outer_splits,data,best_params_file)

    auc_test_df.to_csv('Base_GDSC_nested_outer_CV_result.csv', sep=',')

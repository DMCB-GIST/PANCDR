...
from ModelTraining.PANCDR import train_PANCDR_nested_regr
...
if __name__ == '__main__':
    ...
    n_outer_splits = 10
    best_params_file = "tuned_hyperparameters/GDSC_nested_outer_CV_regr_params.csv"
    p_test_df = train_PANCDR_nested_regr(n_outer_splits,data,best_params_file)

    p_test_df.to_csv('GDSC_nested_outer_CV_regr_result.csv', sep=',')
